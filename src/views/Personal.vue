  ...
  <n-grid :y-gap="3" cols="3" item-responsive>
    ...
    <n-grid-item span="0:3 600:2" id="item">
      ...
      <n-card title="使用方法">
          ...
          (4). 我们承诺, 我们留存的用户数据全部采用业内标准的加密格式, 而我们的数据库也采用异地的方式, 我们不会用用户的个人隐私数据开玩笑, 某些说我们盗取用户数据的人, 也请你们说话过过脑子, 不要错误引导其他用户<br/>
          (5). 不准搭建关于赌博, 黄色, 血腥, 暴力, 爆破, 发包, 代刷网, 发卡网等有违中国法律的站点或服务, 一经发现, 我们有不在事先通知用户的情况下删除隧道, 封停账户, 将信息上报公安的权力, 不要试图挑战我们的底线<br/>
...
<script setup>
import { NCard, NAlert, NButton, NSpace, useMessage, NGrid, NGridItem, NStatistic, NNumberAnimation, NDivider } from "naive-ui";
